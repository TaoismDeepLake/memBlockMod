package com.idealland.memblock.entity.creatures;

import com.idealland.memblock.blocks.blockMoroon.BlockMoroonBase;
...
public class EntityModUnit extends EntityCreature {
    ...
    //�ڼ��Ѷ��������Ѷȵķ�Χ��0.75�C1.5������ͨ�Ѷ�ʱΪ1.5�C4.0���������Ѷ�ʱΪ2.25�C6.75��
