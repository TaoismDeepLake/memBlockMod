package com.idealland.memblock.events;
...
import static com.idealland.memblock.util.NBTStrDef.IDLNBTDef.*;
...
//				  CommonFunctions.SendMsgToPlayerStyled((EntityPlayerMP)player, "memblock.msg.starter_kit_given", TextFormatting.AQUA);
//			  }
